...
public class MainActivity extends AppCompatActivity {
    ...
    private DecimalFormat precision = new DecimalFormat("0.00000000");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double resultBtc = Double.parseDouble(valor.getText().toString()) / mBTC.getBuy();
                mTvBtc.setText(precision.format(resultBtc));

                Double resultLtc = Double.parseDouble(valor.getText().toString()) / mLTC.getBuy();
                mTvLtc.setText(precision.format(resultLtc));

                Double resultXrp = Double.parseDouble(valor.getText().toString()) / mXRP.getBuy();
                mTvXrp.setText(precision.format(resultXrp));

                Double resultEth = Double.parseDouble(valor.getText().toString()) / mETH.getBuy();
                mTvEth.setText(precision.format(resultEth));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            Toast.makeText(this,"Carregando Preços",Toast.LENGTH_LONG).show();
            startDownload();
